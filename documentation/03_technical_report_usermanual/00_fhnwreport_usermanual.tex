...
\title{
	\textsc{\LARGE{Betriebshandbuch}}\\[10mm]
...
\setcounter{page}{1}
\section{Spezifikationen}\label{sec:spezifikationen}
\input{10_spezifikationen}
\clearpage
...
\pagenumbering{arabic}
\setcounter{page}{1}
\section{Kurzanleitung}\label{sec:kurzanleitung}
\input{20_kurzanleitung}
\clearpage
