...
Ziel dieses Projektes ist es, ein Museumsführer names Dojo zu realisieren.
...
Dojo ist ein moderner Museumführer, der ohne Kopfhörer auskommt. Mittels Knochenschallkopfhörer soll der Benutzer die Informationen über die jeweiligen Kunstobjekte erhalten.
Das stabförmige Gerät informiert via Körperschallübertragung über alle Kunstobjekte in dessen Nähe man sich aufhält. Man muss lediglich das Ende des Stabes hinter dem Ohr halten und hört die «Geisterstimme» mit den Ausführungen zum Kunstobjekt.
