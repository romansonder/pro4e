\title{
	Dojo - Mehr als nur ein Museumführer
}
...
\fssummary{
    Wenn es nach Jana Kalbermatter, einer Absolventin der HGK, geht, sollten 		Museen schon längst modernisiert werden. Ihr letzter Museumsbesuch hat 			gezeigt, dass beim ziellosen umherschweifen Kunstwerke oftmals nicht 			wahrgenommen werden und am Ende nur das Erlebnis ''Besuch'' und nicht 			die Kunstwerke in Erinnernung bleiben. Mit dem Dojo, einem stabförmigen 		Museumsführer soll sich dies nun ändern.
}
