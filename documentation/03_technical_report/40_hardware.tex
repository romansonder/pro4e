...
\subsection{Audio-Schnittstelle}\label{sec:AUDIO}
  ...
  \begin{figure}[h]
	 \subfigure[Bei 2kHz kann eine Resonanz beobachtet werden.]{\includegraphics[width=0.49\textwidth]{graphics/123111.png}} 
    \subfigure[Die Resonanz bei 2kHz ist nicht vorhanden.]{\includegraphics[width=0.49\textwidth]{graphics/123222.png}}
